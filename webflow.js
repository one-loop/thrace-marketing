...
! function(t) {
  ...
  r.env.safari = /safari/.test(m) && !_ && !b, y && s.on("touchstart mousedown", function(t) { E = t.target }), r.validClick = y ? function(t) { return t === E || u.contains(t, E) } : function() { return !0 };
  ...
  function A() { I && (I.reject(), c.off("load", I.resolve)), I = new u.Deferred, c.on("load", I.resolve) }
  r.resize = T(c, w), r.scroll = T(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = T(), r.location = function(t) { window.location = t }, r.env() && (r.location = function() {}), r.ready = function() { p = !0, v ? (v = !1, l.each(i, h)) : l.each(o, O), l.each(a, O), r.resize.up() }, r.load = function(t) { I.then(t) }, r.destroy = function(t) { t = t || {}, v = !0, c.triggerHandler("__wf_destroy"), null != t.domready && (p = t.domready), l.each(i, g), r.resize.off(), r.scroll.off(), r.redraw.off(), o = [], a = [], "pending" === I.state() && A() }, u(r.ready), A(), t.exports = window.Webflow = r
}, function(t, e) {
  var n = Array.isArray;
  t.exports = n
}, function(t, e, n) {
  ...
  e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = g, e.replaceAt = E, e.getIn = m, e.set = y, e.setIn = _, e.update = b, e.updateIn = I, e.merge = w, e.mergeDeep = T, e.mergeIn = O, e.omit = A, e.addDefaults = x;
  /*!
   * Timm
   *
  ...
  function b(t, e, n) { return y(t, e, n(null == t ? void 0 : t[e])) }

  function I(t, e, n) { return _(t, e, n(m(t, e))) }
  ...
  var S = { clone: c, addLast: l, addFirst: d, removeLast: p, removeFirst: v, insert: h, removeAt: g, replaceAt: E, getIn: m, set: y, setIn: _, update: b, updateIn: I, merge: w, mergeDeep: T, mergeIn: O, omit: A, addDefaults: x };
  e.default = S
}, function(t, e, n) {
  var r = n(6).Symbol;
  t.exports = r
  ...
  e.instanceAdded = function(t) { return { type: b, payload: (0, i.default)({}, t) } };
  e.instanceStarted = function(t, e) { return { type: I, payload: { instanceId: t, time: e } } };
  ...
  window.tram = function(t) {
      ...
      var P = e.frame = function() { var t = v.requestAnimationFrame || v.webkitRequestAnimationFrame || v.mozRequestAnimationFrame || v.oRequestAnimationFrame || v.msRequestAnimationFrame; return t && N.bind ? t.bind(v) : function(t) { v.setTimeout(t, 16) } }(),
          ...
          X = f(F, function(t, e) { t.init = function() { e.init.apply(this, arguments), this.original || (this.original = this.convert(this.get(), y)) } }),
          G = f(F, function(t, e) { t.init = function() { e.init.apply(this, arguments), this.animate = this.fallback }, t.get = function() { return this.$el[this.name]() }, t.update = function(t) { this.$el[this.name](t) } }),
          U = f(F, function(t, e) {
      ...
      var z = t.style,
          ...
          Q = { color: [X, y], background: [X, y, "background-color"], "outline-color": [X, y], "border-color": [X, y], "border-top-color": [X, y], "border-right-color": [X, y], "border-bottom-color": [X, y], "border-left-color": [X, y], "border-width": [F, _], "border-top-width": [F, _], "border-right-width": [F, _], "border-bottom-width": [F, _], "border-left-width": [F, _], "border-spacing": [F, _], "letter-spacing": [F, _], margin: [F, _], "margin-top": [F, _], "margin-right": [F, _], "margin-bottom": [F, _], "margin-left": [F, _], padding: [F, _], "padding-top": [F, _], "padding-right": [F, _], "padding-bottom": [F, _], "padding-left": [F, _], "outline-width": [F, _], opacity: [F, m], top: [F, b], right: [F, b], bottom: [F, b], left: [F, b], "font-size": [F, b], "text-indent": [F, b], "word-spacing": [F, b], width: [F, b], "min-width": [F, b], "max-width": [F, b], height: [F, b], "min-height": [F, b], "max-height": [F, b], "line-height": [F, w], "scroll-top": [G, m, "scrollTop"], "scroll-left": [G, m, "scrollLeft"] },
          q = {};
      N.transform && (Q.transform = [U], q = { x: [b, "translateX"], y: [b, "translateY"], rotate: [I], rotateX: [I], rotateY: [I], scale: [m], scaleX: [m], scaleY: [m], skew: [I], skewX: [I], skewY: [I] }), N.transform && N.backface && (q.z = [b, "translateZ"], q.rotateZ = [I], q.scaleZ = [m], q.perspective = [_]);
      var $ = /ms/,
          Z = /s|\./;
      return t.tram = e
  }(window.jQuery)
  ...
  var a = o(n(31)),
      ...
      I = function(t) { return b.includes(t) },
  ...
  function at(t) {
      ...
      i && n.dispatch((0, m.rawDataImported)(i)), u.active || (n.dispatch((0, m.sessionInitialized)({ hasBoundaryNodes: Boolean(document.querySelector(O)), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })), o && (function(t) {
          ...
          ft(t), (0, v.default)(e, function(e, n) {
                                  ...
                                  a && t.forEach(function(t, i) {
                                      ...
                                      ! function(t) {
                                          ...
                                          b.forEach(function(t) {
                                              ...
                                              n.forEach(function(t) {
                                                  ...
                                                  if (o) {
                                                      ...
                                                      if (m[u] = function() {
                                                          ...
                                                          E[u] = !0;
                                                          var c = t.config;
                                                          C({ config: c, event: h, eventTarget: i, elementRoot: a, elementApi: y }).forEach(function(t) { _.push({ element: t, key: u }) })
                                                      }
                                                  }
                                              })
                                              ...
                                              mt({ store: e, element: n, eventId: o, actionListId: u, actionItem: a, destination: p, continuous: !0, parameterId: I, actionGroups: i, smoothing: f, restingValue: l, pluginInstance: d })
                                          })
              ...
              var e = function() { ft(t) };
              st.forEach(function(n) { window.addEventListener(n, e), t.dispatch((0, m.eventListenerAdded)(window, [n, e])) }), e()
          }(t)
      }(n), -1 === (e = document.documentElement).className.indexOf(S) && (e.className += " ".concat(S)), n.getState().ixSession.hasDefinedMediaQueries && function(t) { D({ store: t, select: function(t) { return t.ixSession.mediaQueryKey }, onChange: function() { ut(t), j({ store: t, elementApi: y }), at({ store: t, allowEvents: !0 }), nt() } }) }(n)), n.dispatch((0, m.sessionStarted)()), function(t, e) {
          ! function n(r) {
              var i = t.getState(),
                  o = i.ixSession,
                  a = i.ixParameters;
  ...
  var lt = function(t, e) { return (0, l.default)((0, p.default)(t, e), d.default) },
      dt = function(t, e) {
          (0, v.default)(t, function(t, n) { t.forEach(function(t, r) { e(t, n, n + T + r) }) })
      },
      pt = function(t) { var e = { target: t.target, targets: t.targets }; return C({ config: e, elementApi: y }) };
      ...
      return T.forEach(function(t, e) {
          ...
          if (p) {
              ...
              C({ config: u, event: h, eventTarget: i, elementRoot: v, elementApi: y }).forEach(function(u, p) {
                  ...
                  mt({ store: n, element: u, actionItem: t, eventId: r, eventTarget: i, eventStateKey: o, actionListId: a, groupIndex: c, isCarrier: g, computedStyle: E, destination: m, immediate: f, verbose: l, pluginInstance: v, pluginDuration: h, instanceDelay: w })
              })
          }
      }), S
  }
  ...
  function mt(t) {
      ...
      var S = X(c, O, i, s, y, l);
      r.dispatch((0, m.instanceAdded)((0, a.default)({ instanceId: E, elementId: T, origin: S, refType: A, skipMotion: x, skipToValue: n }, o))), _t(document.body, "ix2-animation-started", E), f ? function(t, e) {
      ...
      }(r, E) : (D({ store: r, select: function(t) { return t.ixInstances[E] }, onChange: bt }), h && r.dispatch((0, m.instanceStarted)(E, I.tick)))
  }
...
}, function(t, e, n) { n(130), n(132), n(133), n(134), n(135), n(18), n(137), n(332), n(333), n(334), n(335), n(336), n(341), n(342), n(343), t.exports = n(344) }, function(t, e, n) {
  "use strict";
  var r = n(2);
  ...
  if (a || d.state) {
      var E = d.state || (d.state = new g),
          ...
          y = c(E.has),
          _ = c(E.set);
      r = function(t, e) { if (y(E, t)) throw new h("Object already initialized"); return e.facade = t, _(E, t, e), e }, i = function(t) { return m(E, t) || {} }, o = function(t) { return y(E, t) }
  } else {
      var b = p("state");
      v[b] = !0, r = function(t, e) { if (l(t, b)) throw new h("Object already initialized"); return e.facade = t, f(t, b, e), e }, i = function(t) { return l(t, b) ? t[b] : {} }, o = function(t) { return l(t, b) }
  }
  ...
  function b(t, e, n, i, o) { var u = n === a ? (0, r.getIn)(o, ["config", "target", "objectId"]) : null; return (0, r.mergeIn)(t, [i], { id: i, ref: e, refId: u, refType: n }) }
  ...
  }, e.getRenderType = It, e.getStyleProp = function(t, e) { return t === Q ? e.replace("STYLE_", "").toLowerCase() : null }, e.renderHTMLElement = function(t, e, n, r, i, o, a, u, c) {
      switch (u) {
          case Y:
  ...
  var f = s(n(270)),
      ...
      dt = Object.freeze((i = {}, (0, c.default)(i, m.TRANSFORM_PREFIXED, b), (0, c.default)(i, P, _), (0, c.default)(i, C, C), (0, c.default)(i, N, N), (0, c.default)(i, L, L), (0, c.default)(i, D, D), i)),
      pt = {},
      vt = 1;
  var ht = 1;
  ...
  function mt(t) {
      ...
      if (A === v.EventAppliesTo.PAGE) { var S = f(I); return S ? [S] : [] }
      var R, C, N, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[I || T] || {},
          D = Boolean(L.id || L.selector),
          P = o && l(Et(o.target));
      if (D ? (R = L.limitAffectedElements, C = P, N = l(L)) : C = N = l({ id: I, selector: T, selectorGuids: O }), o && x) { var M = a && (N || !0 === x) ? [a] : d(P); if (N) { if (x === G) return d(N).filter(function(t) { return M.some(function(e) { return E(t, e) }) }); if (x === k) return d(N).filter(function(t) { return M.some(function(e) { return E(e, t) }) }); if (x === X) return d(N).filter(function(t) { return M.some(function(e) { return y(e, t) }) }) } return M }
      return null == C || null == N ? [] : m.IS_BROWSER_ENV && u ? d(N).filter(function(t) { return u.contains(t) }) : R === k ? d(C, N) : R === F ? p(d(C)).filter(g(N)) : R === X ? h(d(C)).filter(g(N)) : d(N)
  }
  var yt = /px/,
  ...
  function It(t) { return /^TRANSFORM_/.test(t) ? Y : /^STYLE_/.test(t) ? Q : /^GENERAL_/.test(t) ? K : /^PLUGIN_/.test(t) ? q : void 0 }
      ...
      I = function(t, e) {
          ...
          for (var x = 0, S = i.length; x < S; x++) {
              ...
              if (0 === x && (m = N[0]), A >= C) {
                  ...
                  var L = i[x + 1],
                      D = L && A !== C;
                  _ = D ? L.actionItems[0] : null, D && (b = C / 100, I = (L.keyframe - C) / 100)
              }
          }
          var P = {};
          if (m && !_)
              for (var M = 0, j = a.length; M < j; M++) {
                  ...
                  for (var F = (O - b) / I, X = m.config.easing, G = h(X, F, f), U = 0, V = a.length; U < V; U++) {
                      var W = a[U],
                          B = y(s, W, m.config),
  ...
  t.exports = function(t, e, n) {
      ...
      function b() {
          var t = i();
          if (_(t)) return I(t);
          p = setTimeout(b, function(t) { var n = e - (t - v); return E ? c(n, l - (t - h)) : n }(t))
      }

      function I(t) { return p = void 0, m && s ? y(t) : (s = f = void 0, d) }

      function w() {
          var t = i(),
              n = _(t);
          if (s = arguments, f = this, v = t, n) { if (void 0 === p) return function(t) { return h = t, p = setTimeout(b, e), g ? y(t) : d }(v); if (E) return clearTimeout(p), p = setTimeout(b, e), y(v) }
          return void 0 === p && (p = setTimeout(b, e)), d
      }
      return e = o(e) || 0, r(n) && (g = !!n.leading, l = (E = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : l, m = "trailing" in n ? !!n.trailing : m), w.cancel = function() { void 0 !== p && clearTimeout(p), h = 0, s = v = f = p = void 0 }, w.flush = function() { return void 0 === p ? d : I(i()) }, w
  }
}, function(t, e, n) {
  var r = n(6);
  ...
  var c, s, f, l = u(n(31)),
      ...
      Et = (r = {}, (0, o.default)(r, S, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, x, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, C, vt()), (0, o.default)(r, N, ht()), (0, o.default)(r, V, { types: "ecommerce-cart-open", handler: et(Z, tt) }), (0, o.default)(r, U, { types: "ecommerce-cart-close", handler: et(Z, tt) }), (0, o.default)(r, _, {
      ...
      }), (0, o.default)(r, b, { types: "click", handler: et(Z, pt(function(t, e) { 2 === e.clickCount && tt(t) })) }), (0, o.default)(r, I, (0, l.default)({}, nt, { types: "mousedown" })), (0, o.default)(r, w, (0, l.default)({}, nt, { types: "mouseup" })), (0, o.default)(r, T, { types: "mouseover mouseout", handler: et(Z, lt(function(t, e) { e.elementHovered && tt(t) })) }), (0, o.default)(r, O, { types: "mouseover mouseout", handler: et(Z, lt(function(t, e) { e.elementHovered || tt(t) })) }), (0, o.default)(r, P, {
          ...
          handler: function(t) {
              ...
              return T && (O > .95 || O < .05) && (O = Math.round(O)), (u !== h.EventBasedOn.ELEMENT || x || x !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, E.parameterChanged)(A, O))), { elementHovered: x, clientX: v, clientY: m, pageX: _, pageY: I }
          }
      }), (0, o.default)(r, B, {
          types: it,
          handler: function(t) {
  ...
  r.define("dropdown", t.exports = function(t, e) {
      ...
      function x() { n = l && r.env("design"), (c = A.find(v)).each(S) }
      ...
      function S(e, i) {
          ...
          var g = C(f, a);
          n && f.el.on(O, function(t) { return function(e, n) { n = n || {}, R(t), !0 === n.open && N(t), !1 === n.open && L(t, { immediate: !0 }) } }(f)), n || (l && (f.hovering = !1, L(f)), f.config.hover && f.toggle.on(_, function(t) { return function() { t.hovering = !0, N(t) } }(f)), f.el.on(T, g), f.el.on(y, function(t) {
              return function(e) {
      ...
      return f.ready = x, f.design = function() { d && A.find(v).each(function(e, n) { t(n).triggerHandler(T) }), d = !1, x() }, f.preview = function() { d = !0, x() }, f
  })
}, function(t, e, n) {
  "use strict";
  var r = n(1)(n(337)),
  ...
  i.define("forms", t.exports = function(t, e) {
      ...
      function _(e, n) {
          ...
          i.done = a.find("> .w-form-done"), i.fail = a.find("> .w-form-fail"), i.fileUploads = a.find(".w-file-upload"), i.fileUploads.each(function(e) {
              ! function(e, n) {
                  ...
                  E || l.on("click keydown", function(t) { "keydown" === t.type && 13 !== t.which && 32 !== t.which || (t.preventDefault(), f.click()) });
                  if (l.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), E) f.on("click", function(t) { t.preventDefault() }), l.on("click", function(t) { t.preventDefault() }), d.on("click", function(t) { t.preventDefault() });
                  else {
                  ...
                  function T(t) {
                      var r = t.responseJSON && t.responseJSON.msg,
                          i = _;
                      "string" == typeof r && 0 === r.indexOf("InvalidFileTypeError") ? i = y : "string" == typeof r && 0 === r.indexOf("MaxFileSizeError") && (i = m), p.text(i), f.removeAttr("data-value"), f.val(""), a.toggle(!1), o.toggle(!0), s.toggle(!0), s.focus(), n.fileUploads[e].uploading = !1, x() || b(n)
                  }
      ...
      function O(e) {
          ...
          }(n), I(e), o ? t.ajax({ url: u, type: "POST", data: r, dataType: "json", crossDomain: !0 }).done(function(t) { t && 200 === t.code && (e.success = !0), x(e) }).fail(function() { x(e) }) : x(e)
      }
      ...
      function A(n) {
          ...
          if (!/^https/.test(l.href) || /^https/.test(n.action)) {
              ...
              var o, a = w(r, i);
              if (a) return g(a);
              I(n), e.each(i, function(t, e) { v.test(e) && (i.EMAIL = t), /^((full[ _-]?)?name)$/i.test(e) && (o = t), /^(first[ _-]?name)$/i.test(e) && (i.FNAME = t), /^(last[ _-]?name)$/i.test(e) && (i.LNAME = t) }), o && !i.FNAME && (o = o.split(" "), i.FNAME = o[0], i.LNAME = i.LNAME || o[1]);
              var u = n.action.replace("/post?", "/post-json?") + "&c=?",
                  c = u.indexOf("u=") + 2;
              c = u.substring(c, u.indexOf("&", c));
              var s = u.indexOf("id=") + 3;
              s = u.substring(s, u.indexOf("&", s)), i["b_" + c + "_" + s] = "", t.ajax({ url: u, data: i, dataType: "jsonp" }).done(function(t) { n.success = "success" === t.result || /already/.test(t.msg), n.success || console.info("MailChimp error: " + t.msg), x(n) }).fail(function() { x(n) })
  ...
  function s(t, e) { t.attr("aria-label") || t.attr("aria-label", e) }
  ...
  function f(t, e, n, r) {
          ...
          if (t !== o) {
              ...
              return o = t, f.spinner.attr("aria-hidden", !1).attr("aria-busy", !0).attr("aria-valuenow", 0).attr("aria-valuetext", "Loading image"), l.show(), C(e.html && (s = e.width, p = e.height, "data:image/svg+xml;charset=utf-8," + encodeURI('<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + p + '"/>')) || e.url, function(r) {
                  if (t === o) {
                      ...
                      e.html && ((a = (i = n(e.html)).is("iframe")) && i.on("load", E), s.append(P(i, "embed"))), e.caption && s.append(F("caption", "figcaption").text(e.caption)), f.spinner.before(h), a || E()
                  }

                  function E() {
                      if (f.spinner.attr("aria-hidden", !0).attr("aria-busy", !1).attr("aria-valuenow", 100).attr("aria-valuetext", "Loaded image"), l.hide(), t === o) {
                          var e = function(t, e) { return -1 === u(t - 1, e) }(t, g);
                          j(f.arrowLeft, "inactive", e), k(f.arrowLeft, e), e && f.arrowLeft.is(":focus") && f.arrowRight.focus();
                          var n, r = function(t, e) { return -1 === c(t + 1, e) }(t, g);
                          if (j(f.arrowRight, "inactive", r), k(f.arrowRight, r), r && f.arrowRight.is(":focus") && f.arrowLeft.focus(), f.view ? (d(f.view).add("opacity .3s").start({ opacity: 0 }).then((n = f.view, function() { n.remove() })), d(h).add("opacity .3s").add("transform .3s").set({ x: t > v ? "80px" : "-80px" }).start({ opacity: 1, x: 0 })) : h.css("opacity", 1), f.view = h, f.view.prop("tabIndex", 0), f.items) {
              ...
              }), f.close.prop("tabIndex", 0), n(":focus").addClass("active-lightbox"), 0 === E.length && (n("body").children().each(function() { n(this).hasClass("w-lightbox-backdrop") || n(this).is("script") || (E.push({ node: n(this), hidden: n(this).attr("aria-hidden"), tabIndex: n(this).attr("tabIndex") }), n(this).attr("aria-hidden", !0).attr("tabIndex", -1)) }), f.close.focus()), m
          }
      }, m.hide = function() { return d(f.lightbox).add("opacity .3s").start({ opacity: 0 }).then(R), m }, m.prev = function() {
          var t = u(o - 1, g);
          t > -1 && m.show(t)
      }, m.next = function() {
          var t = c(o + 1, g);
      ...
      var _ = y(m.prev),
          ...
          T = function(t, e) { t.preventDefault(), "left" === e.direction ? m.next() : "right" === e.direction && m.prev() },
          O = function() { this.focus() };
      ...
      function C(t, e) { var n = F("img", "img"); return n.one("load", function() { e(n) }), n.attr("src", t), n }

      function N(t, e, n) { this.$element = t, this.className = e, this.delay = n || 200, this.hide() }

      function L(t, e) { return t.replace(h, (e ? " ." : " ") + v) }

      function D(t) { return L(t, !0) }

      function P(t, e) { return t.addClass(L(e)) }

      function M(t, e) { return t.removeClass(L(e)) }

      function j(t, e, n) { return t.toggleClass(L(e), n) }

      function k(t, e) { return t.attr("aria-hidden", e).attr("tabIndex", e ? -1 : 0) }

      function F(t, r) { return P(n(e.createElement(r || "div")), t) }
  ...
  r.define("lightbox", t.exports = function(t) {
      ...
      function d(t) {
          ...
          if (r) {
              ...
              }(r), r.items.forEach(function(e) { e.$el = t.el }), (e = r.group) ? ((n = i[e]) || (n = i[e] = []), t.items = n, r.items.length && (t.index = n.length, n.push.apply(n, r.items))) : (t.items = r.items, t.index = 0)
          } else t.items = []
      }
      return o.ready = o.design = o.preview = function() { n = a && r.env("design"), u.destroy(), i = {}, (e = c.find(l)).webflowLightBox(), e.each(function() { s(t(this), "open lightbox"), t(this).attr("aria-haspopup", "dialog") }) }, jQuery.fn.extend({
          webflowLightBox: function() {
              t.each(this, function(e, r) {
                  var i = t.data(r, l);
                  i || (i = t.data(r, l, { el: t(r), mode: "images", images: [], embed: "" })), i.el.off(l), d(i), n ? i.el.on("setting" + l, d.bind(null, i)) : i.el.on("click" + l, function(t) { return function() { t.items.length && u(t.items, t.index || 0) } }(i)).on("click" + l, function(t) { t.preventDefault() })
              })
          }
      }), o
  })
  ...
  r.define("navbar", t.exports = function(t, e) {
      ...
      function X(t, e) {
          if (!t.open) {
              t.open = !0, t.menu.each(k), t.links.addClass(b), t.dropdowns.addClass(m), t.dropdownToggle.addClass(y), t.dropdownList.addClass(_), t.button.addClass(E);
              var n = t.config;
  ...
  r.define("slider", t.exports = function(t, e) {
      ...
      function _() { r.resize.off(b), r.redraw.off(s.redraw) }

      function b() { n.filter(":visible").each(P) }

      function I(e, n) {
          var r = t(n),
              i = t.data(n, p);
          i || (i = t.data(n, p, { index: 0, depth: 1, hasFocus: { keyboard: !1, mouse: !1 }, el: r, config: {} })), i.mask = r.children(".w-slider-mask"), i.left = r.children(".w-slider-arrow-left"), i.right = r.children(".w-slider-arrow-right"), i.nav = r.children(".w-slider-nav"), i.slides = i.mask.children(".w-slide"), i.slides.each(E.reset), m && (i.maskWidth = 0), void 0 === r.attr("role") && r.attr("role", "region"), void 0 === r.attr("aria-label") && r.attr("aria-label", "carousel");
      ...
      function w(t) {
          ...
          if (e.duration = null != n ? parseInt(n, 10) : 500, T(t.el.attr("data-infinite")) && (e.infinite = !0), T(t.el.attr("data-disable-swipe")) && (e.disableSwipe = !0), T(t.el.attr("data-hide-arrows")) ? e.hideArrows = !0 : t.config.hideArrows && (t.left.show(), t.right.show()), T(t.el.attr("data-autoplay"))) {
              ...
              u || t.el.off(r).one(r, function() { C(t) })
          }
          var i = t.right.width();
          e.edge = i ? i + 40 : 100, t.config = e
      }

      function T(t) { return "1" === t || "true" === t }
      ...
      function x(t) { return function() { D(t, { index: t.index - 1, vector: -1 }) } }

      function S(t) { return function() { D(t, { index: t.index + 1, vector: 1 }) } }

      function R(t) {
          C(t);
          var e = t.config,
              n = e.timerMax;
          n && t.timerCount++ > n || (t.timerId = window.setTimeout(function() { null == t.timerId || u || (S(t)(), R(t)) }, e.delay))
      }

      function C(t) { window.clearTimeout(t.timerId), t.timerId = null }
      ...
      function N(n) {
          return function(i, a) {
              ...
              if (u && "setting" === i.type) {
                  ...
                  ! function(n, r) {
                      var i = null;
                      r === n.slides.length && (y(), M(n)), e.each(n.anchors, function(e, n) { t(e.els).each(function(e, o) { t(o).index() === r && (i = n) }) }), null != i && D(n, { index: i, immediate: !0 })
                  }(n, a.select)
              } else {
                  if ("swipe" === i.type) { if (c.disableSwipe) return; if (r.env("editor")) return; return "left" === a.direction ? S(n)() : "right" === a.direction ? x(n)() : void 0 }
      ...
      function D(e, n) {
          ...
          var l = e.offsetX || 0,
              ...
              w = "opacity " + b + "ms " + _,
              T = "transform " + b + "ms " + _;
          if (v.find(a).removeAttr("tabindex"), v.removeAttr("aria-hidden"), v.find("*").removeAttr("aria-hidden"), g.find(a).attr("tabindex", "-1"), g.attr("aria-hidden", "true"), g.find("*").attr("aria-hidden", "true"), u || (v.each(E.intro), g.each(E.outro)), n.immediate && !m) return f(v).set(p), void x();
          if (e.index !== e.previous) {
              if (u || e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === y) {
                  var O = Math.round(b - b * r.crossOver),
                      A = Math.round(b - O);
                  return w = "opacity " + O + "ms " + _, f(h).set({ visibility: "" }).add(w).start({ opacity: 0 }), void f(v).set({ visibility: "", x: d, opacity: 0, zIndex: e.depth++ }).add(w).wait(A).then({ opacity: 1 }).then(x)
              }
              if ("fade" === y) return f(h).set({ visibility: "" }).stop(), void f(v).set({ visibility: "", x: d, opacity: 0, zIndex: e.depth++ }).add(w).start({ opacity: 1 }).then(x);
              if ("over" === y) return p = { x: e.endX }, f(h).set({ visibility: "" }).stop(), void f(v).set({ visibility: "", zIndex: e.depth++, x: d + i[e.index].width * I }).add(T).start({ x: d }).then(x);
              r.infinite && c.x ? (f(e.slides.not(h)).set({ visibility: "", x: c.x }).add(T).start({ x: d }), f(h).set({ visibility: "", x: c.from }).add(T).start({ x: c.to }), e.shifted = h) : (r.infinite && e.shifted && (f(e.shifted).set({ visibility: "", x: l }), e.shifted = null), f(e.slides).set({ visibility: "" }).add(T).start({ x: d }))
          }

          function x() { v = t(i[e.index].els), g = e.slides.not(v), "slide" !== y && (p.visibility = "hidden"), f(g).set(p) }
      }

      function P(e, n) { var r = t.data(n, p); if (r) return function(t) { var e = t.mask.width(); if (t.maskWidth !== e) return t.maskWidth = e, !0; return !1 }(r) ? M(r) : void(u && function(e) { var n = 0; if (e.slides.each(function(e, r) { n += t(r).outerWidth(!0) }), e.slidesWidth !== n) return e.slidesWidth = n, !0; return !1 }(r) && M(r)) }
      ...
      function M(e) {
          ...
          c < 0 && (c = 0), e.anchors = [{ els: [], x: 0, width: 0 }], e.slides.each(function(u, s) {
              ...
              i && (i = parseFloat(i) + "px");
              for (var o = 0, a = e.pages; o < a; o++)(n = t(v)).attr("aria-label", "Show slide " + (o + 1) + " of " + a).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"), e.nav.hasClass("w-num") && n.text(o + 1), null != i && n.css({ "margin-left": i, "margin-right": i }), r.push(n);
              e.nav.empty().append(r)
          }(e));
          var s = e.index;
          s >= n && (s = n - 1), D(e, { immediate: !0, index: s })
      }
      return s.ready = function() { u = r.env("design"), y() }, s.design = function() { u = !0, setTimeout(y, 1e3) }, s.preview = function() { u = !1, y() }, s.redraw = function() { m = !0, y(), m = !1 }, s.destroy = _, s
  })
}, function(t, e, n) {
  "use strict";
  var r = n(2),
  ...
  r.define("tabs", t.exports = function(t) {
      ...
      function m() { n = f && r.env("design"), (e = u.find(p)).length && (e.each(b), r.env("preview") && !E && e.each(_), y(), r.redraw.on(o.redraw)) }
